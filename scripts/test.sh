...
treat_examples "constant" "Constants operations (I)" "interval" ""
treat_examples "interval" "Interval operations" "interval" ""
treat_examples "constant_loop" "Constants loops (I)" "interval" ""
treat_examples "interval_loop" "Interval loops" "interval" ""
treat_examples "constant" "Constants operations (P)" "poly" ""
treat_examples "interval" "Interval operations (P)" "poly" ""
