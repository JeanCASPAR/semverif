...
treat_file() {
	...
	then
	    ...
	    echo -e "${RED}missing fail assertions:${RESET} Domain $domain: ${line}"
	...
	then
	    ...
	    echo -e "${BLUE}unexpected fail assertions:${RESET} Domain $domain: ${line}"
...
treat_examples() {
    ...
    bench_name=$2
    domain=$3
    options=--domain=$domain	# analyzer CLI options
    ...
    for file in $(find "${folder}" -iname "*.c" | sort); do
	filename=$(basename $file)
	create_file $file
	...
	if [[ $out -eq 127 ]]; then
	    ...
	    treat_file "$file" "$log" "$expected_folder" "$domain"
	fi
	echo "</td>" >> $index_html
	echo "</tr>" >> $index_html
	end_file $file
...
solved=0
treat_examples "bool" "Boolean operations" "constants" ""
treat_examples "bool" "Boolean operations" "interval" ""
treat_examples "bool" "Boolean operations" "box" ""
treat_examples "bool" "Boolean operations" "oct"
treat_examples "bool" "Boolean operations" "poly" ""
treat_examples "constant" "Constants operations" "constants" ""
treat_examples "constant_loop" "Constants loops" "constants" ""
treat_examples "constant" "Constants operations" "interval" ""
treat_examples "constant" "Constants operations" "box" ""
treat_examples "interval" "Interval operations" "interval" ""
treat_examples "interval" "Interval operations" "box" ""
treat_examples "constant_loop" "Constants loops" "interval" ""
treat_examples "constant_loop" "Constants loops" "box" ""
treat_examples "interval_loop" "Interval loops" "interval" ""
treat_examples "interval_loop" "Interval loops" "box" ""
treat_examples "constant" "Constants operations" "oct" ""
treat_examples "interval" "Interval operations" "oct" ""
treat_examples "constant_loop" "Constants loops" "oct" ""
treat_examples "constant" "Constants operations" "poly" ""
treat_examples "interval" "Interval operations" "poly" ""
treat_examples "constant_loop" "Constants loops" "poly" ""
treat_examples "interval_loop" "Interval loops" "poly" ""
